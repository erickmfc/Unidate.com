  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Qual é o seu perfil?</h2>
      ...
      <div className="grid grid-cols-1 gap-4 mb-6">
        <button
          type="button"
          onClick={() => handleChange('userType', 'aluno')}
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 mb-1">Aluno</h3>
              <p className="text-sm text-gray-600">
                Sou estudante universitário e quero me conectar com outros alunos
              </p>
            </div>
            {formData.userType === 'aluno' && (
        ...
        <button
          type="button"
          onClick={() => handleChange('userType', 'professor')}
          className={`p-6 rounded-xl border-2 transition-all duration-200 text-left ${
        ...
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 mb-1">Professor</h3>
              <p className="text-sm text-gray-600">
                Sou docente e quero compartilhar conhecimento e materiais
              </p>
            </div>
            {formData.userType === 'professor' && (
              <CheckCircle className="h-5 w-5 text-purple-500" />
        ...
        <button
          type="button"
          onClick={() => handleChange('userType', 'uni')}
          className={`p-6 rounded-xl border-2 transition-all duration-200 text-left ${
            formData.userType === 'uni'
              ? 'border-purple-500 bg-purple-50 shadow-md'
              : 'border-gray-200 hover:border-purple-300 hover:bg-gray-50'
          }`}
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 mb-1">Uni</h3>
              <p className="text-sm text-gray-600">
                Represento uma universidade ou instituição de ensino
              </p>
            </div>
            {formData.userType === 'uni' && (
              <CheckCircle className="h-5 w-5 text-purple-500" />
