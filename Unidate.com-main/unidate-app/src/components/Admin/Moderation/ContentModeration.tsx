...
import { AdminModerationService, ModerationReport } from '../../../services/adminModerationService';

type Report = ModerationReport;
...
const ContentModeration: React.FC = () => {
  ...
  const handleReportAction = async (reportId: string, action: 'ignore' | 'remove' | 'warn' | 'suspend') => {
    try {
      ...
      console.log(`✅ Ação ${action} aplicada com sucesso`);
    } catch (error) {
