...
import TwitterStylePost from '../components/Feed/TwitterStylePost';
            ...
            <div className="fixed inset-0 z-50 lg:hidden">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-80 bg-white shadow-xl overflow-y-auto">
                <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-gray-900">Colegas Sugeridos</h2>
                  <button
                    onClick={() => setShowProfilesDrawer(false)}
                ...
                <div className="p-4">
                  <SuggestedProfiles maxProfiles={10} />
                </div>
              </div>
            </div>
          )}
