...
const AIControlPanel: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'personas' | 'campaigns' | 'bot-posts'>('dashboard');
  const [botPostsTab, setBotPostsTab] = useState<'control' | 'profiles'>('control');
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          {[
            ...
            { id: 'bot-posts', label: 'Bot de Posts', icon: MessageSquare }
      ...
      {activeTab === 'bot-posts' && (
        <div className="space-y-6">
          <div className="border-b border-gray-200 dark:border-gray-700">
            <nav className="-mb-px flex space-x-8">
              <button
                onClick={() => setBotPostsTab('control')}
              ...
              <button
                onClick={() => setBotPostsTab('profiles')}
                className={`py-2 px-1 border-b-2 font-medium text-sm ${
                  botPostsTab === 'profiles'
                    ? 'border-purple-500 text-purple-600 dark:text-purple-400'
                    : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                }`}
              >
