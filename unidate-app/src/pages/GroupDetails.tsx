  ...
  const handleJoinGroup = async () => {
    ...
    try {
      ...
      setGroup(prev => prev ? {
        ...
        members: isJoining 
          ? [...prev.members, currentUser.uid]
          : prev.members.filter(uid => uid !== currentUser.uid)
      } : null);
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          {/* Group Image */}
          <div className="w-full h-48 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl mb-6 flex items-center justify-center">
